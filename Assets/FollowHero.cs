...
public class FollowHero : MonoBehaviour {
	...
	void Update () {
        ...
        //Отримуємо доступ до компонента Transform //це Скорочення до GetComponent<Transform> 
        ...
        Vector3 rabit_position = rabit_transform.position; Vector3 camera_position = camera_transform.position;
        //Рухаємо камеру тільки по X,Y
        camera_position.x = rabit_position.x; camera_position.y = rabit_position.y;
